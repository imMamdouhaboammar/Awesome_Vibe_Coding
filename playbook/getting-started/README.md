...
| 3 | [Build Your Default Stack](./03-build-your-default-stack.md) | Stop picking tools every time. Build a repeatable setup — including a runtime safety layer and the Superhero Prompt to arm your agent before coding. |
